...
// Text
$_['text_success']            = 'Заказ изменен!';
$_['text_order_id']           = 'Номер заказ:';
$_['text_invoice_no']         = 'Номер счет-фактуы:';
$_['text_invoice_date']       = 'Дата счет-фактуы:';
...
$_['text_affiliate']          = 'Аффелиат:';
$_['text_commission']         = 'Коммисия:';
$_['text_ip']                 = 'IP адрес:';
$_['text_forwarded_ip']                       = 'Перенаправленный IP:';
...
$_['text_city']               = 'Город:';
$_['text_zone']               = 'Область / Регион:';
$_['text_zone_code']          = 'Код региона:';
$_['text_country']            = 'Страна:';
$_['text_download']           = 'Загрузки заказа';
...
$_['text_product']            = 'Добавить продукты';
$_['text_voucher']                            = 'Добавить купон';
...
$_['text_reward_remove']      = 'Убрать бонусные баллы';
$_['text_reward_removed']     = 'Бонусные баллы успешно убраны!';
$_['text_commission_add']     = 'Добавить комиссию';
$_['text_commission_added']   = 'Комиссия успешно добавлена!';
$_['text_commission_remove']  = 'Убрать комиссию';
$_['text_commission_removed'] = 'Комиссия успешно убрана!';
$_['text_credit_add']         = 'Добавить виртуальные деньги';
...
$_['text_country_match']                      = 'Совпадение страны:<br /><span class="help">Совпадает ли IP с адресом выставления счета.</span>';
$_['text_country_code']                       = 'Код страны:<br /><span class="help">Код страны по IP адресу.</span>';
$_['text_high_risk_country']                  = 'Страна с высоким риском:<br /><span class="help">Этот IP или адрес оплаты пинадлежит к Ghana, Nigeria, или Vietnam.</span>';
...
$_['column_remaining']      = 'Осталось загрузок';
...
$_['entry_option']            = 'Выберите параметр:';
...
$_['entry_message']                           = 'Сообшение:';
$_['entry_amount']                            = 'Сумма:';
$_['entry_affiliate']         = 'Аффелиат:';
