...
$_['entry_meta_keywords']  = 'Ключевые слова:';
...
$_['entry_weight_class']      = 'Единица измерения оюъема:';
...
$_['entry_return_status']       = 'Статус возврата:<br /><span class="help">Установите статус, при котором возврат обработан.</span>';
...
$_['entry_stock_warning']       = 'Сообщать, если товар закончился:<br /><span class="help">Отображать сообщение в корзине, о том, что товар закончился.</span>';
...
$_['entry_image_manufacturer']  = 'Размер изображения списка производителей:';
$_['entry_image_compare']       = 'Размер изображения списка сравнения:<br /><span class="help">Он же размер логотипа производителя</span>';
