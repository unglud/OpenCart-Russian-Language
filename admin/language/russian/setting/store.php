...
$_['entry_stock_check']       = 'Показывать недостаток на складе:<br /><span class="help">Показывать сообщение о дефиците товара на складе на странице магазина.</span>';
...
$_['button_delete_store']     = 'Удалить магазин';
