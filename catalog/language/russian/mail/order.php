...
$_['text_update_comment']       = 'Комментарии к заказу:';
$_['text_update_link']          = 'Чтобы просмотреть детали заказа, пройдите по ссылке ниже:';
$_['text_update_footer']        = 'Пожалуйста, ответьте на это письмо, если у вас возникли какие-либо вопросы.';
?>